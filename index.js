...
app.get('/patient/patient_register',function(req,res){
    res.sendFile(__dirname + '/pages/patient/pages-regiser.html');
});

app.get('/patient/patient_login',function(req,res){
    res.sendFile(__dirname + '/pages/patient/pages-login.html');
});
